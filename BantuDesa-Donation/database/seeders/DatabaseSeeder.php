...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $countries = 'https://raw.githubusercontent.com/dr5hn/countries-states-cities-database/master/sql/countries.sql';
        // DB::unprepared(file_get_contents($countries));

        // $this->command->info('Seeding states...');
        // $states = 'https://raw.githubusercontent.com/dr5hn/countries-states-cities-database/master/sql/states.sql';
        // DB::unprepared(file_get_contents($states));

        // $this->command->info('Seeding cities...');
        // $cities = 'https://raw.githubusercontent.com/dr5hn/countries-states-cities-database/master/sql/cities.sql';
